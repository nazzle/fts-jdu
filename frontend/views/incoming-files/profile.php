            ...
            <div class="col-md-3">
                ...
                <div class="box-body box-profile">
                  ...
                  <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                      <b>Total files you sent</b> <a class="pull-right">1,322</a>
                    </li>
                    <li class="list-group-item">
                      <b>Total files you received</b> <a class="pull-right">543</a>
                    </li>
                    <li class="list-group-item">
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">   
                  ...
                  <p class="text-muted">PPF Tower, Dar es salaam</p>

                  <hr>

                  <strong><i class="fa fa-user margin-r-5"></i>User Designated Post </strong>
                  <p>
                    <span class="label label-warning">JDU Staff</span>
                  </p>

                  <hr>

                  <strong><i class="fa fa-thumb-tack margin-r-5"></i> Unit Motto</strong>
                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        ...
                        <span class='username'>
                          <a href="#"> Your system username is <?php echo Yii::$app->user->identity->username ?> </a>
                          <a href='#' class='pull-right btn-box-tool'><i class='fa fa-times'></i></a>
                        </span>
                        <span class='description'> Granted privileges: <?php echo Yii::$app->user->identity->privileges ?> and user type is <?php echo Yii::$app->user->identity->type ?></span>
                      </div><!-- /.user-block -->
                      <p>
