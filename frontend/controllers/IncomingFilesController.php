...
use frontend\models\IncomingFilesSearch;
 ...
 */
class IncomingFilesController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new IncomingFilesSearch();
    ...
    {            
        ...
        $todayModel = new Dashboard();
        $todayProvider = new ActiveDataProvider([
        'query' => Dashboard::find()->
                  andWhere(['recipient_id' => Yii::$app->user->identity->id ])
//                ->andWhere(['not', ['recipient_time' => null]])
//                ->andWhere(['date' => date('Y-m-d')])
                 ->andWhere(['registry_status' => 'Return To Registry'])
                ]);
        
        $todayProvider->pagination = ['pageSize' => 5];
        $todayProvider->setSort([
        'attributes' => [
            'id' => [
                'asc' => ['id' => SORT_ASC],
                'desc' => ['id' => SORT_DESC],
    ...
    */
    ...
    /**
     * Deletes an existing IncomingFiles model.
