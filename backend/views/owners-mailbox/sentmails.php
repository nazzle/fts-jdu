              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li ><a <a href="<?= Url::to(['mailbox/index'])?>"><i class="fa fa-inbox"></i> Received SMS <?= $sms > 0? '<span class="label label-primary pull-right">'. $sms.'</span>' : ''; ?></a></li>
                    <li class="active"><a <a href="<?= Url::to(['mailbox/sentmails'])?>"><i class="fa fa-envelope-o"></i> Sent SMS</a></li>
                  </ul>
                </div><!-- /.box-body -->
              </div><!-- /. box -->
            </div><!-- /.col -->  
...
$this->registerJs("
    ...
    $('td').click(function (e) {
        ...
        if(e.target == this)
            location.href = '" . Url::to(['mailbox/viewmailsent']) . "&id=' + id;
    });
