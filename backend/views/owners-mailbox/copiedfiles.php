...
<div class="mailbox-index" >
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a href="<?= Url::to(['mailbox/ccfiles'])?>"><i class="fa fa-file-text-o"></i> Cc: Files <?= $ccfiles > 0? '<span class="label label-primary pull-right">'. $ccfiles.'</span>' : ''; ?></a></li>
                    <li><a href="<?= Url::to(['mailbox/index'])?>"><i class="fa fa-inbox"></i> Received SMS <?= $sms > 0? '<span class="label label-primary pull-right">'. $sms.'</span>' : ''; ?> </a></li>
    ...
    <?= GridView::widget([
        ...
        'rowOptions'   => function ($ccfiles, $key, $index, $grid) {
                            if($ccfiles->status == 7){
                                return [
                                    'class' => 'success',
                                    'data-id' => $ccfiles->id
...
$this->registerJs("
    ...
    $('td').click(function (e) {
        ...
        if(e.target == this)
            location.href = '" . Url::to(['copied-files/view']) . "&id=' + id;
    });
