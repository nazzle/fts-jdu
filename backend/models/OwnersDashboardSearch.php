...
/**
 * DashboardSearch represents the model behind the search form of `backend\models\Dashboard`.
 */
class OwnersDashboardSearch extends OwnersDashboard
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['file_id'], 'exist', 'skipOnError' => true, 'targetClass' => \frontend\models\Files::className(), 'targetAttribute' => ['file_id' => 'file_id']],
            [['file_status'], 'exist', 'skipOnError' => true, 'targetClass' => FileStatus::className(), 'targetAttribute' => ['status_id' => 'file_status']],
            [['forwarded_to'], 'exist', 'skipOnError' => true, 'targetClass' => \frontend\models\Positions::className(), 'targetAttribute' => ['id' => 'forwarded_to']],
            [['from_who'], 'exist', 'skipOnError' => true, 'targetClass' => \frontend\models\Positions::className(), 'targetAttribute' => ['id' => 'from_who']],
            [['subject'], 'exist', 'skipOnError' => true, 'targetClass' => \frontend\models\Files::className(), 'targetAttribute' => ['file_name' => 'subject']],
        ];
    }
